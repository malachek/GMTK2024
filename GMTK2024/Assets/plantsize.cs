...
public class PlantGrowth : MonoBehaviour
{
    ...
    private int missedwaterPresses = 0; // to track the number of times S was not pressed
    ...
    void Start()
    {
        ...
        // To make the target growby 10 units in the y-axis
        ...
        // Assign the audio clips to the audio sources
    ...
    void Update()
    {
        ...
        {
            missedwaterPresses = 0; // reset missed presses when "S" is pressed
            slowedGrowth = false; // reset growth speed
            growthtime = 8f; // reset growth time
        }

        // to check if 4 seconds have passed and "T" was not pressed
